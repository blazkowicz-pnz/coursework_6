# Generated by Django 3.2.6 on 2022-09-25 15:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, help_text='Введите описание товара', max_length=999, null=True, verbose_name='Описание товара')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(help_text='Введите комментарий', max_length=1000, verbose_name='Комментарий')),
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='Введите время создания комментария', verbose_name='Время создания комментиария')),
                ('ad', models.ForeignKey(help_text='Объявление к которому относистя комментарий', on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='ads.ad', verbose_name='Объявление')),
